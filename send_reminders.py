...
# from app.utils import send_whatsapp_message, get_tomorrow_reservations, append_message, send_whatsapp_template
...
#             send_whatsapp_template(reservation['wa_id'], message)
