...
export function AnimatedSidebarTrigger({ className, freeRoam = false }: AnimatedSidebarTriggerProps) {
    ...
    <>
      ...
      <Button
        ...
        className={cn(
          ...
          open ? "opacity-0 pointer-events-none scale-95" : "opacity-100 pointer-events-auto scale-100",
      ...
      >
        <Button
          ...
          size="icon"
          className={cn(
            "h-7 w-7 animated-sidebar-trigger",
            className
          )}
          onClick={toggleSidebar}
