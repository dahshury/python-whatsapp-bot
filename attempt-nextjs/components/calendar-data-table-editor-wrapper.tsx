...
import { filterEventsForDataTable, transformEventsForDataTable } from '@/lib/calendar-event-processor'
  ...
  return (
    <LazyDataTableEditor
      ...
      events={shouldLoadEditor ? 
        transformEventsForDataTable(filterEventsForDataTable(events, freeRoam)) 
        : []
      }
