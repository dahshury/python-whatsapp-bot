...
class WebSocketManager:
    ...
    async def _handle_connection(self, websocket: WebSocketServerProtocol):
        ...
        try:
            ...
            welcome_message = WebSocketMessage(
                ...
                data={"message": "Connected to real-time updates", "status": "connected"}
            )
            ...
            async for message in websocket:
                try:
                    ...
                    logging.warning(f"Invalid JSON received from {websocket.remote_address}")
                except Exception as e:
    ...
    def _should_send_to_connection(self, websocket: WebSocketServerProtocol, message: WebSocketMessage) -> bool:
        """
    ...
    async def broadcast_update(self, update_type: UpdateType, data: Dict[str, Any], 
        ...
        # Send to all connected clients with appropriate filtering
        disconnected = set()
    ...
    async def broadcast_reservation_update(self, action: str, reservation_data: Dict[str, Any]):
        """
        ...
        affected_entities = [str(reservation_data.get("id", "")), reservation_data.get("wa_id", "")]
    ...
    async def broadcast_conversation_update(self, conversation_data: Dict[str, Any]):
        ...
        await self.broadcast_update(UpdateType.CONVERSATION_NEW_MESSAGE, conversation_data, affected_entities)
    ...
    async def broadcast_customer_update(self, customer_data: Dict[str, Any]):
        ...
        await self.broadcast_update(UpdateType.CUSTOMER_UPDATED, customer_data, affected_entities)
