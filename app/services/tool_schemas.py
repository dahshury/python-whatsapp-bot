...
TOOL_DEFINITIONS = [
    ...
    },
    {
        ...
        "schema": {"type": "object", "properties": {"include_past": {"type": "boolean", "description": "Flag to include past reservations. defaults to False."}}, "required": []}
    },
    {
