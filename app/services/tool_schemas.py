...
TOOL_DEFINITIONS = [
    ...
    },
    {
        ...
        "schema": {
            ...
            "properties": {
                ...
                "max_reservations": {"type": "integer", "description": "Maximum reservations per slot. defaults to 5."},
                "hijri": {
                    "type": "boolean",
    ...
    },
    {
        ...
        "schema": {
            ...
            "required": ["customer_name", "date_str", "time_slot", "reservation_type"],
            "additionalProperties": False,
        },
    },
    {
        ...
        "schema": {
            ...
            "properties": {
                ...
                "new_name": {"type": "string", "description": "New customer name."},
                "new_type": {"type": "integer", "description": "Reservation type (0 for Check-Up, 1 for Follow-Up)."},
                "hijri": {
                    "type": "boolean",
                    "description": "Flag indicating if the provided input date string to this function is in Hijri format. The hijri date should be in the format (YYYY-MM-DD). defaults to False.",
                },
...
FUNCTION_MAPPING = {name: func for name, func in inspect.getmembers(assistant_functions) if inspect.isfunction(func)}
