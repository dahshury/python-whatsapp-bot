...
class CustomerService(BaseService):
    ...
    async def modify_customer_wa_id(
    ...
    async def update_customer_name(
        ...
        try:
            ...
            save_success = await self.repository.save(
                customer
    ...
    async def get_or_create_customer(
        self, wa_id: str, customer_name: Optional[str] = None
    ) -> Customer:
        """
    ...
    async def ensure_customer_exists(
        ...
        if not customer:
            ...
            success = await self.repository.add_customer(
                wa_id, customer_name or "Unknown"
            )
            if success:
                customer = await self.repository.get_customer(wa_id)
