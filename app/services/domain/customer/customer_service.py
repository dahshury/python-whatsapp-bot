...
class CustomerService(BaseService):
    ...
    def update_customer_age(self, wa_id: str, age: int | None, ar: bool = False) -> dict[str, Any]:
    ...
    def get_or_create_customer(self, wa_id: str, customer_name: str | None = None) -> Customer:
        """
