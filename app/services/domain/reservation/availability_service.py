...
class AvailabilityService(BaseService):
    ...
    def __init__(
        self, reservation_repository: ReservationRepository | None = None, **kwargs
    ):
        """
        ...
        try:
            ...
            for slot_12h, slot_24h in time_format_map.items():
                try:
                    ...
                    self.logger.error(
                        f"Error checking slot {slot_24h} on {parsed_date_str}: {e}"
                    )
                    continue
        ...
        try:
            ...
            for day_offset in date_range:
                ...
                if time_slot is None:
                    result = self.get_available_time_slots(
