...
export type EventDurationSettings = {
	strategy: 'auto' | 'manual'
	defaultMinutes: number
	perTypeMinutes: Record<string, number>
}

export type SlotCapacityRoleConfig = {
	totalMax: number
	perTypeMax: Record<string, number>
}

export type SlotCapacitySettings = {
	agent: SlotCapacityRoleConfig
	secretary: SlotCapacityRoleConfig
}
...
export type EventDurationSettingsDto = {
	strategy: 'auto' | 'manual'
	default_minutes: number
	per_type_minutes: Record<string, number>
}

export type SlotCapacityRoleDto = {
	total_max: number
	per_type_max: Record<string, number>
}

export type SlotCapacitySettingsDto = {
	agent: SlotCapacityRoleDto
	secretary: SlotCapacityRoleDto
}
...
export type AppConfigDto = {
	...
	available_calendar_views: string[]
	timezone: string
	llm_provider: string
	...
	event_duration_settings?: EventDurationSettingsDto | null
	slot_capacity_settings?: SlotCapacitySettingsDto | null
	created_at: string
	updated_at: string
}
