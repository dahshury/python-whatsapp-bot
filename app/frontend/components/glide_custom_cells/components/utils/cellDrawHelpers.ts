...
export function drawAttentionIndicator(
  ...
  const startColor = getComputedStyle(document.documentElement)
    .getPropertyValue('--gdg-validation-error-start')?.trim() || 'rgba(239, 68, 68, 0.15)';
  const endColor = getComputedStyle(document.documentElement)
    .getPropertyValue('--gdg-validation-error-end')?.trim() || 'rgba(255, 255, 255, 0)';
  ...
  const borderColor = getComputedStyle(document.documentElement)
    .getPropertyValue('--gdg-validation-error-border')?.trim() || 'rgba(239, 68, 68, 0.3)';
  ...
  const indicatorColor = getComputedStyle(document.documentElement)
    .getPropertyValue('--gdg-validation-error-indicator')?.trim() || theme.accentColor;
  ctx.beginPath();
