      ...
      return (
        <RPNInput.default
          ...
          inputComponent={(inputProps) => (
            <InputComponent {...inputProps} onCustomerSelect={onCustomerSelect} mainOnChange={onChange} />
          )}
          smartCaret
...
const InputComponent = React.forwardRef<
  HTMLInputElement,
  InputComponentProps
>(({ className, onCustomerSelect, onChange, onBlur, onKeyDown, value, placeholder, disabled, mainOnChange, ...props }, ref) => {
  ...
  const handleCustomerChange = (phone: string, customerName?: string) => {
    ...
    if (onCustomerSelect && customerName !== undefined) {
      console.log('Calling onCustomerSelect for existing customer:', phone, customerName)
    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent 
        ...
        onPointerDownOutside={(e) => {
          ...
          if (target.closest('.ScrollbarsCustom-Track') ||
