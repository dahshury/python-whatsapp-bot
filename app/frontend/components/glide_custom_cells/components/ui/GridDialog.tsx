...
export function GridDialog({
  ...
  const { handlePointerDownOutside, handleEscapeKeyDown, handleInteractOutside } = useGridDialogInteraction({
      ...
      >
        ...
        >
          ...
          <div 
            ...
            style={{ borderColor: 'var(--gdg-border-color, hsl(var(--border)))' }}
          >
            ...
            <div className={`flex items-center gap-2 ${isRTL ? 'flex-row-reverse' : ''}`}>
              ...
              {showCloseButton && (
                <button
                  ...
                  style={{ marginLeft: isRTL ? 0 : '8px', marginRight: isRTL ? '8px' : 0 }}
                >
                  <svg
                    width="15"
                    height="15"
