    ...
    <div className="fixed inset-0 z-[999998]" data-enhanced-column-menu>
      ...
      >
        ...
        <div 
          ...
          style={{
            padding: '8px 12px',
            borderBottom: '1px solid var(--gdg-menu-border, hsl(var(--border)))',
            fontSize: '14px',
            fontWeight: '500',
            display: 'flex',
            alignItems: 'center',
            ...
            <div key={section}>
              {sectionIndex > 0 && (
                <div style={{
                  height: '1px',
                  margin: '4px 8px',
                  backgroundColor: 'var(--gdg-menu-border, hsl(var(--border)))'
                }} />
              )}
              ...
              {items.map((item) => (
                <button
                  ...
                  style={{
                    ...
                    justifyContent: item.hasSubmenu ? 'space-between' : 'flex-start'
                  }}
                  onMouseEnter={(e) => {
                    e.currentTarget.style.backgroundColor = 'var(--gdg-menu-hover-bg, hsl(var(--accent)))'
                    e.currentTarget.style.color = 'var(--gdg-menu-hover-text, hsl(var(--accent-foreground)))'
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.backgroundColor = 'transparent'
                    e.currentTarget.style.color = 'var(--gdg-menu-text, hsl(var(--popover-foreground)))'
                  }}
                >
