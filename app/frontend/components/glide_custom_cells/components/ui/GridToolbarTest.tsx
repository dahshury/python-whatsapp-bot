...
export const GridToolbarTest: React.FC<GridToolbarTestProps> = ({ 
  ...
  const [hasHiddenColumns, setHasHiddenColumns] = React.useState(true);
  ...
  if (inDialog) {
    return (
      <div className="p-4">
        <h3 className="text-lg font-semibold mb-4">Grid Toolbar Test - Dialog Mode</h3>
        ...
        <div className="fixed inset-4 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 max-w-4xl w-full max-h-[90vh]">
          <div className="bg-background rounded-lg shadow-xl flex flex-col h-full border">
            ...
            <div className="flex-1 overflow-hidden p-6 relative">
              <FullscreenProvider>
                <GridPortalProvider>
                  <div style={{ height: '400px', backgroundColor: '#f5f5f5', position: 'relative' }}>
                    <div style={{ padding: '20px', textAlign: 'center' }}>
                      <p>Simulated Grid Content Area</p>
                      <p className="text-sm text-muted-foreground mt-2">
                        The toolbar should appear in the top-right corner, above this content.
                      </p>
  ...
  return (
    <div className="p-4">
      <h3 className="text-lg font-semibold mb-4">Grid Toolbar Test - Normal Mode</h3>
      
      <div className="relative border rounded-lg" style={{ height: '400px', width: '600px' }}>
        <FullscreenProvider>
          <GridPortalProvider container={containerRef.current}>
            <div ref={containerRef} style={{ position: 'relative', height: '100%', backgroundColor: '#f5f5f5' }}>
              <div style={{ padding: '20px', textAlign: 'center' }}>
                <p>Simulated Grid Content Area</p>
                <p className="text-sm text-muted-foreground mt-2">
