...
const ToolbarButton: React.FC<ToolbarButtonProps> = ({ 
  ...
  const buttonStyle: React.CSSProperties = {
    background: isHovered && !disabled ? "var(--gdg-toolbar-hover-bg, rgba(0, 0, 0, 0.1))" : "transparent",
    border: "none",
    padding: "3px",
    cursor: disabled ? "not-allowed" : "pointer",
    color: isHovered && !disabled ? "var(--gdg-toolbar-hover-icon, #000)" : "var(--gdg-toolbar-icon, #666)",
    borderRadius: "3px",
