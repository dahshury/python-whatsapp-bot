...
export function useGridPersistence(
    ...
    const loadState = React.useCallback(() => {
        ...
        if (savedState) {
            ...
            const baseColumnPropsLoaded: BaseColumnProps[] = state.columnDefinitions || 
            ...
            console.log("Loading columns:", baseColumnPropsLoaded.map(c => ({ id: c.id, name: c.name, title: c.title })));
