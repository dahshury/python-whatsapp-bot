...
function ResponseTimeMetric({ title, value, unit, icon, variant = 'default', description, isRTL }: ResponseTimeMetricProps) {
...
export function ResponseTimeAnalysis({ conversationAnalysis, isRTL }: ResponseTimeAnalysisProps) {
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Badge variant="outline" className={getScoreColor(performanceScore)}>
          {i18n.getMessage('response_time_score', isRTL)}: {performanceScore.toFixed(0)}%
        </Badge>
      </div>
