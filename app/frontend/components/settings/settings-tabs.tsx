...
import { View, Settings2, Plane } from "lucide-react"
...
export function SettingsTabs({
  ...
  React.useEffect(() => {
    if (activeTab === "vacation" && (viewMode !== "default" || !isCalendarPage)) {
      onTabChange?.("general")
    }
  ...
  return (
    <Tabs value={activeTab} onValueChange={onTabChange}>
      <TabsList className={cn(
        ...
        showViewTab && showVacationTab ? "grid-cols-3" : 
        showViewTab ? "grid-cols-2" : "grid-cols-1"
      )}>
        {showViewTab && (
