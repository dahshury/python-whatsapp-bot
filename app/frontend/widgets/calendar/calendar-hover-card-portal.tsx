...
export function CalendarHoverCardPortal({
	...
	return createPortal(
		...
		>
			{/* biome-ignore lint/a11y/noStaticElementInteractions lint/a11y/noNoninteractiveElementInteractions: Interactive hover card with mouse and focus handlers */}
			<div
				className={cn(
					"pointer-events-auto relative w-full overflow-visible rounded-md border bg-popover text-popover-foreground shadow-md",
					exitClass,
					activeClass
				)}
				onBlur={onMouseLeave}
