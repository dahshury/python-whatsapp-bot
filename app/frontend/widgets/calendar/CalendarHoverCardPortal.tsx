...
export function CalendarHoverCardPortal({
	...
	return createPortal(
		<div
			className={cn("fixed pointer-events-none w-[18.75rem] calendar-hover-card-portal")}
			style={{
				zIndex: "var(--z-hover-card)",
				left: `${hoverCardPosition.x}px`,
				top: hoverCardPosition.preferBottom ? `${hoverCardPosition.y}px` : `${hoverCardPosition.y}px`,
