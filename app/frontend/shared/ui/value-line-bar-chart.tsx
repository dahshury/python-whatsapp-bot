...
const MIN_BAR_OPACITY = 0.2
const REFERENCE_LABEL_Y_OFFSET = 9
const REFERENCE_LABEL_TEXT_X_OFFSET = 6
const REFERENCE_LABEL_TEXT_Y_OFFSET = 4
	...
	return (
		<>
			<rect
				...
				width={width}
				x={x - CHART_MARGIN}
				y={y - REFERENCE_LABEL_Y_OFFSET}
			/>
			<text
				fill="var(--primary-foreground)"
				fontWeight={600}
				x={x - CHART_MARGIN + REFERENCE_LABEL_TEXT_X_OFFSET}
				y={y + REFERENCE_LABEL_TEXT_Y_OFFSET}
			>
				{value}
			</text>
		</>
