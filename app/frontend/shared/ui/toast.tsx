...
// biome-ignore lint/performance/noNamespaceImport: Radix UI toast primitives are commonly used as namespace import for type references
...
const ToastViewport = ({
	...
	ref?: RefObject<ElementRef<typeof ToastPrimitives.Viewport> | null>
}) => (
	<ToastPrimitives.Viewport
		className={cn(
			'fixed top-0 flex max-h-screen w-full flex-col-reverse p-4 sm:top-auto sm:right-0 sm:bottom-0 sm:flex-col md:max-w-[26.25rem]',
			className
		)}
		ref={ref}
...
const Toast = ({
	...
	VariantProps<typeof toastVariants> & {
		ref?: RefObject<ElementRef<typeof ToastPrimitives.Root> | null>
	}) => (
...
const ToastAction = ({
	...
	ref?: RefObject<ElementRef<typeof ToastPrimitives.Action> | null>
}) => (
...
const ToastClose = ({
	...
	ref?: RefObject<ElementRef<typeof ToastPrimitives.Close> | null>
}) => (
...
const ToastTitle = ({
	...
	ref?: RefObject<ElementRef<typeof ToastPrimitives.Title> | null>
}) => (
...
const ToastDescription = ({
	...
	ref?: RefObject<ElementRef<typeof ToastPrimitives.Description> | null>
}) => (
