...
function Select(props: React.ComponentProps<typeof SelectPrimitive.Root>) {
	...
	const Override = getOverride<React.ComponentProps<typeof SelectPrimitive.Root>>(
...
>(({ className, children, ...props }, ref) => {
	const OV = useUiCompositeOverride("Select");
	const Override = getOverride<React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger>>(
		OV as unknown as Record<string, unknown>,
		"SelectTrigger"
	);
	if (Override) {
...
>(({ className, children, position = "popper", ...props }, ref) => {
	const OV = useUiCompositeOverride("Select");
	const Override = getOverride<React.ComponentPropsWithoutRef<typeof SelectPrimitive.Content>>(
		OV as unknown as Record<string, unknown>,
		"SelectContent"
	);
	if (Override) {
