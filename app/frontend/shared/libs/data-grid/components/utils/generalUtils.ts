...
export function deepClone<T>(obj: T): T {
	...
	if (typeof obj === "object") {
		...
		const clonedObj = Object.create(Object.getPrototypeOf(original)) as Record<string, unknown>;
...
export function parseWidth(width?: "small" | "medium" | "large" | number): number | undefined {
 ...
 */
export function wrapAsync<T extends (...args: unknown[]) => Promise<unknown>>(fn: T, context?: string): T {
 ...
 */
export function wrapSync<T extends (...args: unknown[]) => unknown>(fn: T, context?: string): T {
	return ((...args: Parameters<T>) => {
		try {
			return fn(...args);
		} catch (error) {
