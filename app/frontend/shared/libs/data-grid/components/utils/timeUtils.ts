...
export const isValidDate = (date: unknown): date is Date => {
	...
	if (Number.isNaN(hours) || Number.isNaN(minutes) || Number.isNaN(seconds) || Number.isNaN(milliseconds)) return false;
...
export const formatTimeForDisplay = (date: Date | undefined, use24Hour = false): string => {
