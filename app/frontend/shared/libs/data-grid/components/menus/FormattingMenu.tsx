...
import { BarChart3, Calculator, Calendar, Clock, FileText, Hash, Percent, TrendingUp } from "lucide-react";
		...
		>
			{formats.map((formatOption) => (
				<FormatMenuItem
					...
					label={getFormatLabel(formatOption.format, (key) => i18n.getMessage(key, isLocalized))}
...
function determineColumnKind(column: GridColumn): string {
	...
	if (id.includes("datetime") || name.includes("datetime") || id.includes("timestamp") || name.includes("timestamp")) {
		return "datetime";
	}
