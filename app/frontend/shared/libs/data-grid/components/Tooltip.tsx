...
const Tooltip: React.FC<TooltipProps> = ({ content, x, y, visible, fieldLabel, message }) => {
		...
		>
			...
			>
				<div className="flex gap-3">
					<CircleAlert className="mt-0.5 shrink-0 opacity-70" size={16} aria-hidden="true" />
					<div className="space-y-1">
						{fieldLabel && <p className="text-[0.8125rem] font-medium">{fieldLabel}</p>}
