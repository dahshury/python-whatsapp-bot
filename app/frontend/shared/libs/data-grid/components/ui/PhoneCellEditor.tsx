...
const PhoneCellEditor: React.FC<PhoneCellEditorProps> = ({
	...
	return (
		<div className="flex flex-col glide-data-grid-overlay-editor" dir="ltr" style={{ direction: "ltr" }}>
			<GridPhoneCombobox value={value} onChange={onChange} phoneOptions={phoneOptions} allowCreateNew={true} />
		</div>
	);
};
