...
// Animation timing constants for skeleton loaders
const SKELETON_HEIGHT = "24px";
const SKELETON_BORDER_RADIUS = "4px";
const PULSE_ANIMATION_DURATION = "2s";
const PULSE_TIMING_FUNCTION = "cubic-bezier(0.4, 0, 0.6, 1)";
						...
						{Array.from({ length: skeletonColumns }, (_, colIndex) => ({
							...
							<div
								...
								style={{
									...
									animation: `pulse ${PULSE_ANIMATION_DURATION} ${PULSE_TIMING_FUNCTION} infinite`,
									animationDelay: `${(Number.parseInt(key.split("-")[1] || "0", 10) + colIndex) * ANIMATION_STAGGER_DELAY}s`,
								}}
							/>
						))}
					</div>
