...
import { X as Close, Trash2 as Delete, Download, Eye, Maximize, Plus, Redo, Search, Undo } from "lucide-react";
				...
				<MenuBar
					...
					items={[
						...(hasSelection
							? [
									{
										icon: (p: React.SVGProps<SVGSVGElement>) => <Close {...p} size={ICON_SIZE} />,
										label: "Clear selection",
										onClick: onClearSelection,
									},
									{
										icon: (p: React.SVGProps<SVGSVGElement>) => <Delete {...p} size={ICON_SIZE} />,
							...
							: []),
						{
							icon: (p: React.SVGProps<SVGSVGElement>) => <Undo {...p} size={ICON_SIZE} />,
							label: "Undo (Ctrl+Z)",
							onClick: onUndo,
							disabled: !canUndo,
						},
						{
							icon: (p: React.SVGProps<SVGSVGElement>) => <Redo {...p} size={ICON_SIZE} />,
						...
						...(hasSelection
							...
							: [
									{
										icon: (p: React.SVGProps<SVGSVGElement>) => <Plus {...p} size={ICON_SIZE} />,
										label: "Add row",
										onClick: onAddRow,
									},
								]),
						...(hasHiddenColumns
							? [
									{
										icon: (p: React.SVGProps<SVGSVGElement>) => <Eye {...p} size={ICON_SIZE} />,
							...
							: []),
						{
							icon: (p: React.SVGProps<SVGSVGElement>) => <Download {...p} size={ICON_SIZE} />,
							label: "Download as CSV",
							onClick: onDownloadCsv,
						},
						{
							icon: (p: React.SVGProps<SVGSVGElement>) => <Search {...p} size={ICON_SIZE} />,
							label: "Search",
							onClick: onToggleSearch,
						},
						{
							icon: (p: React.SVGProps<SVGSVGElement>) => <Maximize {...p} size={ICON_SIZE} />,
