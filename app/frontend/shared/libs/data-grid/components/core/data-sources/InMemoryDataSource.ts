import { ColumnDataType, type IColumnDefinition, type IDataSource } from "../interfaces/IDataSource";
...
export class InMemoryDataSource implements IDataSource {
	...
	private generateSampleData(row: number, col: number, sampleNames: string[]): unknown {
	...
	async setCellData(col: number, row: number, value: unknown): Promise<boolean> {
