import type { EditableGridCell, GridCell, Theme } from "@glideapps/glide-data-grid";
import type { ColumnDataType, IColumnDefinition, IColumnFormatting } from "./IDataSource";
...
export interface IColumnType {
	...
	coercePasteValue?(value: string, cell: GridCell, column: IColumnDefinition): GridCell | undefined;
}
