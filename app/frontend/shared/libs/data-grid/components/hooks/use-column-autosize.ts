...
const FALLBACK_CHAR_WIDTH = 8; // Fallback character width when canvas context unavailable
const HEADER_PADDING = 16; // Padding for header cells
...
export function useColumnAutosize(options: ColumnAutosizeOptions = {}) {
	...
	const { minWidth = 50, maxWidth = 400, padding = 16 } = options;
