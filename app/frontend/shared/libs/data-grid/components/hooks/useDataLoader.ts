...
export function useDataLoader(
	...
	const loadDataRange = useCallback(
		...
		[loaderState.loadedPages, fullConfig.prefetchPages, performanceMode, loadPage]
	);
	...
	const getCacheStats = useCallback(() => {
		return {
			...
			cacheHitRatio: loaderState.loadedPages.size > 0 ? loaderState.cache.size / loaderState.loadedPages.size : 0,
		};
	}, [loaderState]);
