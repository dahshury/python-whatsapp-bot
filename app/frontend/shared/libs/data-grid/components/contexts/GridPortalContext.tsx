...
export const useGridPortal = () => {
	...
	if (typeof document !== "undefined") {
		const fullscreenOverlay = document.getElementById("grid-fullscreen-overlay-portal");
	...
	return context.portalContainer || (typeof document !== "undefined" ? document.body : null);
};
...
export function GridPortalProvider({ children, container }: GridPortalProviderProps) {
