...
// Fullscreen layout padding constants
const FULLSCREEN_HORIZONTAL_PADDING = 40;
const FULLSCREEN_VERTICAL_PADDING = 100;
...
export const FullscreenProvider: React.FC<{ children: React.ReactNode }> = ({
	...
	const value: FullscreenContextShape = {
		isFullscreen,
		width: isFullscreen
			? windowSize.width - FULLSCREEN_HORIZONTAL_PADDING
			: windowSize.width,
		height: isFullscreen
			? windowSize.height - FULLSCREEN_VERTICAL_PADDING
			: windowSize.height,
		enterFullscreen,
		exitFullscreen,
		toggleFullscreen,
