...
const en = {
	...
	left_calendar: "Left Calendar",
	right_calendar: "Right Calendar",
	...
	please_fill_prefix: "Please fill: ",
	create_failed: "Create Failed",
	create_failed_verbose: "Failed to create reservation",
...
const ar = {
	...
	left_calendar: "التقويم الأيسر",
	right_calendar: "التقويم الأيمن",
	cancel_reservation: "إلغاء الحجز",
	cancelled_reservation: "محجوز ملغي",
	past_reservation: "حجز سابق",
...
// Common UI/navigation and settings labels
Object.assign(en, {
	...
	tab_view: "View",
	tab_general: "General",
	tab_vacation: "Vacation",
	settings_view: "View Settings",
	settings_chat: "Chat Settings",
	settings_show_tool_calls: "Show Tool Calls",
	settings_tool_calls_hint: "Show/hide tool calls in chat messages",
	...
	settings_message_limit_set_prefix: "Message limit set to",
	already_showing_today: "Already showing today",
	...
	conversation_navigation: "Conversation navigation",
	older: "Older",
...
Object.assign(ar, {
	view_changed: "تم تغيير العرض",
	load_more: "تحميل المزيد",
	settings: "الإعدادات",
	tab_view: "العرض",
	tab_general: "عام",
	tab_vacation: "الإجازة",
	settings_view: "إعدادات العرض",
	settings_chat: "إعدادات الدردشة",
	settings_show_tool_calls: "عرض أدوات الاستدعاء",
	settings_tool_calls_hint: "إظهار/إخفاء أدوات الاستدعاء في الدردشة",
	...
	settings_message_limit_set_prefix: "تم تعيين حد الرسائل إلى",
	already_showing_today: "أنت بالفعل في اليوم الحالي",
	go_to_today: "الذهاب إلى اليوم",
	copy: "نسخ",
	copied: "تم النسخ",
	close_dialog: "إغلاق الحوار",
	discard_changes: "تجاهل التغييرات",
	save_and_close: "حفظ والإغلاق",
	cancel: "إلغاء",
	...
	conversation_navigation: "التنقل بين المحادثات",
	older: "الأقدم",
	more_recent: "الأحدث",
...
export const messages = {
	...
	time: {
		justNow: () => (isLocalized() ? "قبل ثوانٍ" : "just now"),
		minAgo: (n: number) => (isLocalized() ? `${n} دقيقة` : `${n} min ago`),
		hoursAgo: (n: number) => (isLocalized() ? `${n} ساعة` : `${n} h ago`),
		daysAgo: (n: number) => (isLocalized() ? `${n} يوم` : `${n} d ago`),
	},
	grid: {
