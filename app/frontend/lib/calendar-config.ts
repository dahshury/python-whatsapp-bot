...
export function getBusinessHours(freeRoam: boolean): any {
  ...
  const normalRules = subtractRamadanFromNormal([
    ...
    { daysOfWeek: [0,1,2,3,4], startTime: "11:00", endTime: "17:00", startRecur: "2022-01-01", endRecur: "2031-12-31" },
    // Sat(6): 16:00-22:00
    { daysOfWeek: [6], startTime: "16:00", endTime: "22:00", startRecur: "2022-01-01", endRecur: "2031-12-31" },
  ], ramadanRules);
