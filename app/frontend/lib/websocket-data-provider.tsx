...
import { useOfflineOverlay } from "@/hooks/useOfflineOverlay";
...
import { computeFullDashboardData } from "@/lib/dashboard/compute";
...
export const WebSocketDataProvider: React.FC<React.PropsWithChildren> = ({
    ...
    const { showOffline, isRetrying, handleRetry } = useOfflineOverlay(ws as unknown as ReturnType<typeof useWebSocketData>);
