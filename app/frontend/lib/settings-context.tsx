...
export const SettingsProvider: React.FC<React.PropsWithChildren<{}>> = ({ children }) => {
  ...
  React.useEffect(() => {
    ...
    if (storedStyleTheme) {
      ...
      if (legacyTheme && legacyTheme.startsWith("theme-")) {
  ...
  const value = React.useMemo<SettingsState>(() => ({ theme, setTheme, freeRoam, setFreeRoam, showDualCalendar, setShowDualCalendar }), [theme, freeRoam, showDualCalendar]);
