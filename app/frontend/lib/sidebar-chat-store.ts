...
export const useSidebarChatStore = create<SidebarChatState>((set) => ({
  ...
  // Legacy open/close
  open: (id) => set((s) => ({ isOpen: true, isChatSidebarOpen: true, selectedConversationId: id ?? s.selectedConversationId })),
  ...
  openConversation: (id) =>
    set({ shouldOpenChat: true, conversationIdToOpen: id, activeTab: "chat", isChatSidebarOpen: true, selectedConversationId: id, isLoadingConversation: true }),
